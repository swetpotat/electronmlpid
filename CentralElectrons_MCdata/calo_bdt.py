...
def plot_confusion_matrix(testing_targets, predictions):
	...
	plt.title('Confusion Matrix for Calorimeter Features')
	plt.ylabel('Predicted Class')
	plt.xlabel('Actual Class')
	plt.savefig('cm_calo.png', bbox_inches = 'tight')
...
def plot_roc_curve(testing_targets, predictions):
	...
	roc_auc = auc(tpr, fpr)
	plt.figure(figsize = (8,5))
	plt.title('ROC for Calorimeter Features')
	...
	plt.savefig('roc_calo.png', bbox_inches = 'tight')
